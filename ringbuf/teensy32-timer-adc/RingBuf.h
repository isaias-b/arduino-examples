...
template<typename T, size_t S> class RingBuf
{
public:
  ...
  inline size_t min(size_t a, size_t b) const { return a < b ? a : b; }
  inline size_t max(size_t a, size_t b) const { return a > b ? a : b; }
